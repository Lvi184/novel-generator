...
def main():
    ...
    for chapter in test_chapters:
        ...
        print(f"第{summary.num}章: {summary.title}")
        print(f"  摘要: {summary.summary[:100]}...")
        print(f"  角色: {', '.join(summary.characters)}")
        print(f"  紧张度: {summary.tension_level}/10")
